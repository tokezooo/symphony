defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          codex_prompt_override_path: nil,
          codex_turn_token_budget: nil,
    ...
    codex_prompt_override_path = Keyword.get(config, :codex_prompt_override_path)
    codex_turn_token_budget = Keyword.get(config, :codex_turn_token_budget)
    ...
    sections =
      [
        ...
        "  prompt_override_path: #{yaml_value(codex_prompt_override_path)}",
        "  turn_token_budget: #{yaml_value(codex_turn_token_budget)}",
